...
#1. HL 
#=====
tr.hl<-read.tree("BAMM/bamm-2.5.0-Windows/tree_hl.tre")
edata_hl<- getEventData(tr.hl, eventdata = "BAMM/bamm-2.5.0-Windows/event_data_trait_hl.txt", 
...
# AMERICAN
#=========
am <- extract.clade(tr.hl, node=48)
am$tip.label
...
# 2. HW 
#########
tr.hw<-read.tree("BAMM/bamm-2.5.0-Windows/tree_hw.tre")
edata_hw<- getEventData(tr.hw, eventdata = "BAMM/bamm-2.5.0-Windows/event_data_trait_hw.txt", 
                        burnin=0.5, type = "trait")
...
# AMERICAN
#=========
am <- extract.clade(tr.hw, node=76)
am$tip.label
...
# 3. FL 
#########
tr.fl<-read.tree("BAMM/bamm-2.5.0-Windows/tree_fl.tre")
edata_fl<- getEventData(tr.fl, eventdata = "BAMM/bamm-2.5.0-Windows/event_data_trait_fl.txt", 
                        burnin=0.5, type = "trait")
...
# AMERICAN
#=========
am <- extract.clade(tr.fl, node=46)
am$tip.label
...
# 4. TL 
#########
tr.tl<-read.tree("BAMM/bamm-2.5.0-Windows/tree_tl.tre")
edata_tl<- getEventData(tr.tl, eventdata = "BAMM/bamm-2.5.0-Windows/event_data_trait_tl.txt", 
                        burnin=0.5, type = "trait")
...
# AMERICAN
#=========
am <- extract.clade(tr.tl, node=49)
am$tip.label
