...
# AMERICA: 
# HL: all BM
# HW: all OU except ELEVavg -> BM
# FL: all BM
# TL: all BM except WINDavg and WINDmax -> OU


hl <-  mat.bm.am2[mat.bm.am2$trait=="phylores_HL",]
hw <- mat.ou.am2[mat.ou.am2$trait=="phylores_HW",]
hw[rownames(hw)=="ELEVavg1",] <- mat.bm.am2[rownames(mat.bm.am2)=="ELEVavg1",]  # BM for this variable
hw

fl <- mat.bm.am2[mat.bm.am2$trait=="phylores_FL",]
tl <- mat.bm.am2[mat.bm.am2$trait=="phylores_TL",]
tl[rownames(tl)=="WINDavg3",] <- mat.ou.am2[rownames(mat.ou.am2)=="WINDavg3",]  # OU for this variable
tl[rownames(tl)=="WINDmax3",] <- mat.ou.am2[rownames(mat.ou.am2)=="WINDmax3",]  # OU for this variable
