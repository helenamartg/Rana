...
# PHYLOGENY
#-----------
phyloRana <- read.tree("DATA/phyloRana_75sp.tre")
phyloRana$tip.label
phyloRana <- drop.tip(phyloRana, 55)  # Remove Rana_psilonota (no svl information)
...
morpho$sp == phylo55sp$subtree$tip.label
...
# BIOME
biome <- read.csv("DATA/biome_all.csv")
